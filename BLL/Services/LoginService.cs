...
namespace BLL.Services
{
    public class LoginService
    {
        ...
        public static List<LoginDTO> Get()
        {
            ...
            var config = new MapperConfiguration(cfg => cfg.CreateMap<Login, LoginDTO>());
        ...
        public static bool Add(LoginDTO dto)
        {
            ...
            var config = new MapperConfiguration(cfg => cfg.CreateMap<LoginDTO, Login>());
            var mapper = new Mapper(config);
            var data = mapper.Map<Login>(dto);
