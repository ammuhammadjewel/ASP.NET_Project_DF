...
namespace DAL.Repos
{
    ...
    {
        public Login Authenticate(string uname, string pass)
        {
            var obj = db.Logins.FirstOrDefault(x => x.Uname.Equals(uname) && x.Password.Equals(pass));
            return obj;
        }
        ...
        {
            return db.UsersDetails.FirstOrDefault(t => t.Uid == id);
        }
